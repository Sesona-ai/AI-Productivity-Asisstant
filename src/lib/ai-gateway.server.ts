...
// Captures/resends the gateway run id across follow-up calls in one request.
...
// Chat-completions provider for non-OpenAI models (e.g. google/gemini-*).
...
// Responses API provider for openai/* models.
